    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "knight", x: 2000, y: groundY - 85, hitSize: 50, velocity: 4, health: -10, image: "img/knight.png", scaleX: 0.2, scaleY: 0.2, offSetX: -105, offSetY: -90},
          { type: "knight", x: 2400, y: groundY - 85, hitSize: 50, velocity: 4, health: -10, image: "img/knight.png", scaleX: 0.2, scaleY: 0.2, offSetX: -105, offSetY: -90},
          { type: "knight", x: 3000, y: groundY - 85, hitSize: 50, velocity: 4, health: -10, image: "img/knight.png", scaleX: 0.2, scaleY: 0.2, offSetX: -105, offSetY: -90},

          { type: "mage", x: 1100, y: groundY - 65, hitSize: 30, velocity: 2, health: -10, image: "img/mage.png", scaleX: 1.2, scaleY: 1.2, offSetX: -70, offSetY: -75},
          { type: "mage", x: 2100, y: groundY - 65, hitSize: 30, velocity: 2, health: -10, image: "img/mage.png", scaleX: 1.2, scaleY: 1.2, offSetX: -70, offSetY: -75},
